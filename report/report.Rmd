...
Strategies that facilitate host-pathogen coexistence may be more universally applicable. 
Direct treatment of larval or post-metamorphic frogs with antifungal agents has been attempted in several species, and generally produces short-term reductions in Bd prevalence or load [@geiger2017antifungal; @hudson2016situ; @hardy2015itraconazole] and associated increases in frog survival [@hudson2016situ]. However, in most cases, these effects disappear within weeks or months of treatment, with little effect on long-term population persistence [@hudson2016situ; but see @hardy2015itraconazole for a possible exception].
...
The translocation of frogs collected from recovering, Bd-infected populations resulted in the long-term reestablishment of an extirpated population [@joseph2018disease], but the success of such efforts may vary widely between sites and species [@joseph2018disease; @brannelly2016chytrid]. 
...
Nonetheless, such trials can provide important insights into host-Bd dynamics that generally cannot be gained from observational studies alone, including those related to life stage-specific outcomes and the role of adaptive immunity. 
In turn, these insights may suggest improvements to future mitigation efforts. 
In the current study, we conducted six Bd treatments in larval, subadult, and adult mountain yellow-legged frogs, including direct treatment of tadpoles and adults using the antifungal drug itraconazole, and one treatment using both itraconazole and microbiome augmentation with the bacterium *J. lividum*. 
...
In contrast to the relatively short-lived effects when early life stages were treated, the two itraconazole treatment experiments in LeConte that focused on adults reduced Bd load and increased frog survival, and these changes persisted throughout the three-year post-treatment period of the study. 
...
Specifically, although treated frogs had lower loads than control frogs throughout the post-treatment period (Bd load of treated frogs: 0--7.6, median = 4.0; control frogs:  3.6--8.2, median = 7.2), Bd load distributions for frogs in the two groups nonetheless overlapped substantially. 
In the region of overlap (3.6--7.6 copies), survival probability was near zero for control frogs, but was higher and relatively constant (~ 0.5) <!-- update this --> for treated frogs. 
This higher survival is consistent with increased tolerance of Bd infection, and along with increased resistance, is suggestive of treated frogs having mounted an effective adaptive immune response against Bd [@ellison2015more; @grogan2018evolution; @mcmahon2014amphibians]. 

<!-- Compare survival with that of persistent populations: Skelton, etc. -->
...
This was likely due to both relatively low adult survival (compared to other enzootic populations<!-- update as necessary -->) and limited recruitment of new adults. 
We counted hundreds of tadpoles and subadults during VES conducted in 2016, 2017, and 2018 (maximum counts per year: 614, 2434, and 480, respectively), but captured relatively few new recruits during the same period. Of the 102 untagged frogs we captured that had sizes typical of new recruits (40--45 mm), 91 were tagged in 2016, nine in 2017, and two in 2018. 
This low recruitment of new adults despite large numbers of early life stages is known from other enzootic *R. sierrae* populations, and is likely a consequence of high chytridiomycosis-caused mortality of frogs during and soon after metamorphosis [@joseph2018disease, and results from Barrett and Dusy treatments described above].

Two results from the adult treatment experiments complicate the interpretation of the overall treatment effect. 
First, at the beginning of the experiment, frogs in the control group were captured and processed 1--3 days after the frogs in the treated group. Because Bd loads in the population were increasing during this period, Bd loads on control frogs were somewhat higher than those on treated frogs. 
This could have exaggerated the effect of treatment on subsequent frog survival by reducing the survival of control frogs relative to that of treated frogs.
...
The pre-treatment Bd loads of control and treated frogs were both very high, and given the relationship between estimated survival and Bd load shown in Figure 5c, survival of frogs over the range of pre-treatment Bd loads observed in both groups would be expected to be relatively constant and near zero. 
In addition, as described previously, for the range of Bd load values that overlapped between control and treated frogs, treated frogs had much higher survival than control frogs.
Both results suggest that the higher survival of treated frogs compared to control frogs during the post-treatment period was primarily due to the reduction in Bd loads caused by the treatment, and not the relatively small difference in pre-treatment Bd loads between control and treated frogs. 

The second complicating result is the unexpectedly large number of non-experimental frogs captured during the post-treatment period. In *R. sierrae* and *R. muscosa* populations, Bd epizootics typically result in the mortality of all, or nearly all, adults within one year [@vredenburg2010dynamics]. 
Based on this, if the treatment increased frog survival as predicted, then during the post-treatment period we would have captured primarily treated frogs, with control frogs and frogs that had not been included in the experiment (i.e., untreated "non-experimental" frogs) being rare or absent. 
...
Based on their sizes, most were older adults that had survived the epizootic, and the remainder were new recruits that had survived the epizootic as subadults. 
...
How these frogs survived the Bd epizootic is unknown. 
...
Although conjectural, it is possible that frogs in some of these associated habitats experienced lower pathogen pressure, lower Bd loads, and higher survival during the epizootic than frogs in the large populations inhabiting the lakes. 

In conclusion, the two LeConte treatment experiments that focused on adult frogs both altered frog-Bd dynamics in a predictable way, including reducing Bd loads of treated versus control frogs and increasing frogs survival. 
...
The relatively few frogs treated and the inability to conduct this treatment as an experiment, with treated and control groups, precludes strong conclusions, but the lack of frog survival one year after treatment indicates that the strong effects of treatment observed in the LeConte experiment are not universal, and may depend on the timing of the treatment relative to the onset of the epizootic (later in Treasure than LeConte) or the inherent susceptibility of the frog population to Bd infection [e.g., @savage2011mhc].

## Microbiome augmentation of subadult frogs {-}

Results from the treatment experiments described above indicate that the effectiveness of treatments in changing long-term frog-Bd dynamics and facilitating populution persistence depends heavily on the survival of subadult frogs under post-epizootic conditions. 
Given the low immunocompetence of subadults against Bd [@rollins1998metamorphosis; @grogan2018review], simply reducing Bd loads on subadults using itraconazole appears insufficient to keep loads sufficiently low over the longer term and increase survival. 
The addition of protective probiotics to the frog skin microbiome may be a possible mean to reduce susceptibility to chytridiomycosis of this vulnerable life stage and increase the survival to adulthood [@rebollar2020amphibian; @harris2009skin; @bletz2013mitigating]. 
...
However, an unexpected outcome of the *J. lividum* experiment was the rapid spread of *J. lividum* from exposed animals to subadults in the study pond at large. 
