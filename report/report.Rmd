...
<!-- 1212 vs. 2212 adults captured. Need to clarify what these numbers are referring to -->
...
In summary, during the three year post-treatment period across both experiments, 51% of treated frogs and 2% of control frogs were recaptured. 
...
In contrast to the relatively short-lived effects of treatment of early life stages, the two itraconazole treatment experiments in LeConte that focused on adults resulted in effects on Bd load and frog survival that were evident throughout the three-year duration of the study. 
Specifically, the reduced Bd loads of treated animals at the end of the treatment period in 2015 were maintained during the 2016-2018 post-treatment period, and were similar to those of adults in populations characterized by enzootic frog-Bd dynamics [@joseph2018disease; @briggs2010enzootic; @knapp2011nowhere] (to allow comparison between zoospore equivalents (ZE) and ITS copies: 1 ZE = 60 copies (Joseph and Knapp 2018)). 
In addition, survival of control frogs was near zero for the entire range of Bd load values that characterized this group (3.6--8.2, median = 7.2), but higher and relatively constant across the range of Bd loads of treated frogs (0--7.6, median = 4.0).
Therefore, treated frogs appeared both more resistant to and tolerant of Bd infection, consistent with treated frogs having developed an effective adaptive immune response against Bd [@ellison2015more; @grogan2018evolution; @mcmahon2014amphibians]. 
...
CHECK TO MAKE SURE NO RECRUITS WERE CAPTURED, MENTION THAT THIS WAS NOT DUE TO A LACK OF SUCCESSFUL REPRODUCTION WHICH WAS PRESENT IN ALL POST-TREATMENT YEARS BASED ON VES. LOOK UP VES RESULTS TO CONFIRM. CONSISTENT WITH LOW SURVIVAL OF SUBADULTS IN THE PRESENCE OF BD INFECTION, AS SEEN IN THE BARRETT-DUSY TREATMENT EXPERIMENTS. 
