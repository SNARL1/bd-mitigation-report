...
# Introduction {-}
<!-- TS: Overall, I think the sentences and content are great. I think the transitions between paragraphs are abrupt, which feels like we lack of enthusiasm.-->
...
<!-- TS: Isn't there a Bosch paper relevant to this? (or is it a rehash of the Garner?)-->
...
<!-- TS: I think the paragraph ends well, but maybe put in short transition sentence to the effect of: 'This leaves no clear way to prevent ongoing declines'.-->
...
<!-- TS: I agree those definitions may have some value--> 

<!-- TS: I feel like a transition is needed here, e.g. 'With few disease naive populations remaining on the landscape, mitigation has become a more attractive strategy to managers and more pressing question for researchers.'-->
<!-- TS: Of the next three paragraphs (let's call them 1, 2, and 3), did you consider presenting them as 2, 3, 1? To me, that arrangement is more in line with the 'funnel' structure for an Introduction (e.g. start general and get progressively more specific). 2 and 3 draw from the larger Bd mitigation literature; but 1 is very specifically about what we did. Paragraph 1 could start with the Objectives; a sentence stating that 'our objective was to test whether lowering individual Bd loads during an epizootic could enhance population survival'. To a reader, encountering the phrase 'we conducted...' may indicate an upcoming transition to the methods. But here, we go on to build up the differences among our treatments.-->
...
<!-- TS: As MJ mentioned, enzootic dynamics may be worth mentioning/defining prior to here, e.g. in the intro to MYL frogs. It is the 'desired' outcome even beyond successful mitigation and survival of treated individuals. I also agree with Max's comment.-->
Early life stages of amphibians have immune systems that appear relatively ineffective against Bd [@rollins1998metamorphosis; @grogan2018review], but adults of at least some species, including MYL frogs, can develop adaptive immune defenses that may be at least partially protective [@ellison2015more; @grogan2018evolution; @mcmahon2014amphibians]. 
...
<!-- TS: I like this paragraph. I think this is a good example of a 'pawn-push' topic sentence (so-called by Schimel) . It works here, because the pulse/press manipulation issue is a fairly clear conflict that a lot of readers will expect to see addressed.  -->
...
<!-- TS: This paragraph teases the results and discussion. In this manuscript, I like it because this paper which is heavy on synthesizing a lot of information and the outline helps readers. But not everyone likes it so it may be risky; I tried it once and reviewers were tepid to unhappy. -->
...
## General methods {-}
<!-- TS: In general, I felt that some sections could use more first-person active voice.-->

### Visual encounter surveys {-}
<!--TS: Should we enhance the introduction to VES and its objectives? Unlike in the report to the parks, general readers will less familiar with the method and the reasons.-->
...
Animals assigned to the "treated" group were held in large mesh pens (2 m $\times$ 2 m $\times$ 0.75 m) for the duration of the multi-day treatment period. <!-- TS: The \times render as asterisks, which looks funny, instead of as 'x' -->
...
<!-- TS: This section is great; very clear. -->
...
Because adults typically succumb to chytridiomycosis early in an epizootic [@vredenburg2010dynamics], at the time of the experiments these populations contained primarily late-stage tadpoles, recently metamorphosed subadults, and occasionally a small number of extant surviving adults. <!-- TS: '...adults typically succumb...early...'.  relating back to the suggestions to describe enzootic Bd-MYL frog dynamics: do we sufficiently describe how persistence [probably] develops when adults do survive the epizootic; although this statement is necessary for the context of the early lifestages treatments, there seems to be potential for confusion.--> 
<!-- TS: The word 'residual' sounded funny, though the gist is clear. -->
...
The effect of frog treatments on Bd concentrations on filters was evaluated using the model *bd_load ~ (pre_post x treatment) + (1 | sample_id)* (family = negative binomial, pre_post = before/after the frog treatment period, sample_id included as a group-level effect to account for replicates). 
<!-- TS: Should some covariate of volume filtered be used, or is the response variable adjusted/standardized by volume? Does this impact the density of zoospores in a sample?  Is there a reference/citation indicating that such a covariate is unnecessary? Was water pulled directly from the lake, or by 'aliquoting' into containers? Unfortunately, this section seems like there could be some pitfalls that reviewers could get hung up on. But I understand that we don't want it to be too long, because the filtration is not remotely the focus of the manuscript. -->
...
We re-swabbed each surviving frog after the final itraconazole treatment, and assessed treatment effectiveness using the model *bd_load ~ treatcat* (family = negative binomial). 
...
This was the case despite considerable overlap in Bd loads between the control and treated/nonexperimental groups (Figure 5a, 5c). 
...
**This is a trivial change made by TomCSmith on 24 September 2021 at 1508 h**
...
<!-- TS: may need to add 'Days (categories)' to the x-axis; that labeling is not entirely clear at quick glance. Try labeling as 'Weeks', and don't use a range for each tick label? e.g. categories are '-2', '0', '1', '3', '6' and so on. I think the day ranges are close enough to weeks that the required simplification may be fine for display -->
...
<!-- TS: Impressive to see that the zsp pool increased in the control ponds over the treatment period/progression of the epizootic?-->
...
<!-- TS: Because A and B have a different x-axis than C, consider repeating the facet strip in C, to interrupt the eyes and help viewer see the different x-axis; a hasty reading might allow one to assume that the x-axis in C is also years, and that survival probability had a temporal correlation. What is the time period for C; does it span all years? Maybe specify in the caption. Also in C, can the rug be taller? I find it hard to see, and this is currently a large format.-->
...
<!-- TS: I concur with the above comment -->
