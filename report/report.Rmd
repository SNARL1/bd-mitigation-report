...
Translocations and reintroductions that utilize amphibians from populations with a long history of Bd exposure and potential selection for more Bd resistant/tolerant genotypes also indicate some promise. 
...
In the two itraconazole treatment experiments focused on early life stage *R. sierrae*, treated populations had reduced Bd loads during the summer in which the treatment was conducted.
...
In contrast to the relatively short-lived effects when early life stages were treated, the two itraconazole treatment experiments in LeConte that focused on adults reduced Bd load and increased frog survival thoughout the three-year post-treatment period of the study (2016-2018). 
...
In addition to this increased resistance against Bd infection, the results also suggest that treated frogs had higher tolerance of Bd infection. 
...
The low recruitment of new adults in 2017 and 2018 despite large numbers of early life stages is known from other enzootic *R. sierrae* populations, and is likely a consequence of high chytridiomycosis-caused mortality of frogs during and soon after metamorphosis [@joseph2018disease, and results from Barrett and Dusy treatments described above].
...
The relatively few frogs treated and the inability to conduct this treatment as an experiment, with treated and control groups, precludes strong conclusions, but the lack of frog survival one year after treatment indicates that the strong effects of treatment observed in the LeConte experiments are not universal, and may depend on the timing of the treatment relative to the onset of the epizootic (later in Treasure than LeConte) or the inherent susceptibility of the frog population to Bd infection [e.g., @savage2011mhc].
...
In this application, the effectiveness of probiotics will depend critically on their ability to establish on the frog skin and maintain sufficiently high densities over the months or years of the subadult-to-adult transition. 
...
In conclusion, although the colonization of frogs by *J. lividum* did not appear to confer increased Bd resistance, its spread from *J. lividum*-exposed to unexposed frogs indicates that if an effective probiotic against Bd infection is ever identified, its introduction into a frog population may be relatively straight-forward.

## Conclusions {-}
Our experiments indicate that treatment of early life stage and adult MYL frogs with antifungal agents during or immediately following epizootics strongly altered frog-Bd dynamics over the short term, but was insufficient to allow treated populations to persist in the presence of Bd over the long term.
