...
In contrast to the relatively short-lived effects when early life stages were treated, the two itraconazole treatment experiments in LeConte that focused on adults caused changes to Bd load and frog survival that persisted throughout the three-year duration of the study. 
Specifically, Bd loads on adults were substantially reduced by treatment in 2015, and these reduced loads were maintained throughout the 2016-2018 post-treatment period and were associated with increased frog survival.
Bd loads on treated adults were similar to those of adults in populations characterized by enzootic frog-Bd dynamics and in which frogs are persisting over the long-term [@joseph2018disease; @briggs2010enzootic; @knapp2011nowhere] (to allow comparison between zoospore equivalents (ZE) and ITS copies: 1 ZE = 60 copies (Joseph and Knapp 2018)).
<!-- Compare survival with that of persistent populations: Skelton, etc. -->

The increased survival of treated frogs was associated with increased resistance against Bd infection (as indicated by lower loads of treated frogs (0--7.6, median = 4.0) than control frogs (3.6--8.2, median = 7.2)), but the results also suggest that treated frogs also had higher tolerance of Bd infection. 
For example, although treated frogs had lower loads than control frogs throughout the post-treatment period, Bd load distributions for frogs in the two groups nonetheless overlapped substantially. 
In this region of overlap (3.6--7.6), survival probability was near zero for control frogs, but was higher and relatively constant (~ 0.5) <!-- update this --> for treated frogs. 
This higher survival is consistent with increased tolerance of Bd infection in treated frogs, and along with increased resistance, suggestive of treated frogs having mounted an effective adaptive immune response against Bd [@ellison2015more; @grogan2018evolution; @mcmahon2014amphibians]. 

Despite this extended period of reduced Bd loads and increased frog survival, the adult population declined in each of the post-treatment years, and few treated frogs remained by 2018. 
This was likely due to both relatively low survival (compared to other enzootic populations<!-- update as necessary -->) and limited recruitment. 
We counted hundreds of tadpoles and subadults during VES conducted in 2016, 2017, and 2018 (maximum counts per year: 614, 2434, and 480, respectively), but detected relatively few new recruits during the same period. Of the 102 untagged frogs we captured that had sizes typical of new recruits (40--45 mm), 91 were tagged in 2016, nine in 2017, and two in 2018. 
This low recruitment of new adults despite large numbers of early life stages is typical of enzootic *R. sierrae* populations and is likely a consequence of high chytridiomycosis-caused mortality of frogs during and soon after metamorphosis [@joseph2018disease, and results from Barrett and Dusy treatments described above].

DISCUSS CAVEATS ASSOCIATED WITH HIGHER LOADS OF CONTROL FROGS AT BEGINNING OF TREATMENT, UNEXPECTED SURVIVAL OF UNTREATED NON-EXPERIMENTAL FROGS. 
