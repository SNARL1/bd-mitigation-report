...
In an effort to reduce the impact of chytridiomycosis, several mitigation measures have been suggested to increase the fraction of frogs surviving chytridiomycosis outbreaks, including treating frogs with antifungal agents [including use of drugs and augmentation of the skin microbiome with probiotics; @woodhams2011mitigating], treating the environment with antifungals to reduce the pool of infectious zoospores, and reducing the density of the host population [@garner2016mitigating]. Al
However, field tests of treatment effectiveness in promoting host population persistence remain uncommon 
