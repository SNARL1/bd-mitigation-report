...
In the current study, we conducted five Bd treatments in larval, subadult, and adult mountain yellow-legged frogs, including direct treatment of tadpoles and adults using the antifungal drug itraconazole, and one treatment using both itraconazole and microbiome augmentation with the bacterium *J. lividum*. 
