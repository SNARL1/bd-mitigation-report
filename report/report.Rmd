...
*Keywords*: amphibian chytrid fungus, *Batrachochytrium dendrobatidis*, epizootic, population decline, antifungal treatment
...
However, field tests of treatment effectiveness remain uncommon [@hardy2015itraconazole; @bosch2015successful; @hudson2016situ; @geiger2017antifungal; @bosch2020significant]. 
...
To increase the probability of frog population persistence through Bd epizootics, during the period 2009-2018 we tested three types of  chytridiomycosis treatments in MYL frog populations during or soon after epizootics, with a goal of reducing Bd infection intensity (i.e., "load") and increasing frog survival and population persistence. 
Treatments included (1) treatment of early life stages (tadpoles and recently metamorphosed subadults) with the antifungal drug itraconazole [@garner2009using], (2) treatment of adults with itraconazole, and (3) treatment of early life stages with *Janthinobacterium lividum*, a symbiotic bacterium on amphibian skin that has antifungal properties [@brucker2008amphibian]. 
...
However, at metamorphosis the skin rapidly keratinizes and is colonized by Bd [@mcmahon2015transition], and this whole-body infection then results in subadult mortality. 
Nonetheless, subadults are often available for treatment for several weeks before they succumb to chytridiomycosis. 
...
Initial studies on the immune response by frogs against Bd suggested that the acquired immune system of adults was ineffective [@rosenblum2012only; @fites2013invasive]. 
However, subsequent discoveries indicate that at least some amphibians, including adult MYL frogs, can develop an acquired immune response that is protective against Bd [@mcmahon2014amphibians; @ellison2015more]. 
...
If true, treating adult frogs with antifungal drugs during an epizootic could slow the growth of Bd and allow the full development of acquired immunity, which in turn could allow increased adult survival and population persistence. To test this possibility, we conducted antifungal treatments of adult frogs in 2015 and 2018. 

NEED SEGUE HERE. Results from several studies suggest that some symbiotic bacteria inhabiting amphibian skin have antifungal properties [@harris2006amphibian; @bletz2013mitigating], and laboratory experiments indicate that their presence can alter frog-Bd dynamics and increase frog survival [@harris2009skin; @kueneman2016probiotic]. 
...
Therefore, prior to exposing frogs to *J. lividum*, we first reduced their Bd loads with antifungal drug treatment. 

ADD FINAL PARAGRAPH STATING THAT ALL TREATMENTS FAILED TO ALLOW LONG-TERM POPULATION PERSISTENCE. HOWEVER, THE COMPREHENSIVE VIEW OF MITIGATION EFFECTIVENESS MAKES THE STUDY RESULTS NONETHELESS VALUABLE FOR UNDERSTANDING THE CONSEQUENCES OF TREATMENTS AND INSIGHTS INTO THE CAUSES OF FAILURE. 
...
However, in 2013 only a single experimental animal was captured during surveys, and no *R. sierrae* of any life stage was detected during surveys in 2014 and 2019. 
